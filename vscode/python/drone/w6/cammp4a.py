        ...
        while True:  
            for frame in container.decode(video=0):  
                ...
                if img_use == 1:  
                    ...
                    out = cv2.VideoWriter(f'{time_str}/{file_index:03d}.mp4', fourcc, 30.0, (width, height))  
...
def handle_keyboard_input(drone):  
    while True:
        ...
        # 處理用戶輸入的邏輯，例如更新 frame_skip 或其他變量
...
# 新增資料夾
os.makedirs(time_str)

print(f"{time_str} 資料夾已重新建立")
